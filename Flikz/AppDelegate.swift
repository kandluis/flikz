...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func getNavigationControllerFor(_ endpoint: String) -> UINavigationController? {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        
        guard let controller = storyboard.instantiateViewController(withIdentifier: "FlikzNavigationController") as? UINavigationController else { return  nil }
